...
class GAN():
    def __init__(self, window_size,
        ...
        self.generator_model.compile(optimizer=Adam(0.0001, beta_1=0.5, beta_2=0.9, clipnorm=10.0),
        ...
        self.discriminator_model.compile(optimizer=Adam(0.0001, beta_1=0.5, beta_2=0.9, clipnorm=10.0),
                                         loss=[self.wasserstein_loss,
